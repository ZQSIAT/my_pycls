...
from pycls.core.net import SoftCrossEntropyLoss, CELossAndHLossAndFLoss
...
_loss_funs = {"cross_entropy": SoftCrossEntropyLoss, "CELossAndHLossAndFLoss": CELossAndHLossAndFLoss}
